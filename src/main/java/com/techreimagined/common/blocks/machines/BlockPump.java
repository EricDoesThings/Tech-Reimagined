package com.techreimagined.common.blocks.machines;
...
import com.techreimagined.common.tileentities.machines.TileEntityPump;
 ...
 */
public class BlockPump extends BlockTileBase {

    public BlockPump() {
        super(Material.IRON, "machines/pump");
        this.setTileEntity(TileEntityPump.class);
        this.setCreativeTab(TechReimaginedCreativeTabs.tabMachines);
        this.setInternalName("pump");
